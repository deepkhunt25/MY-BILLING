  ...
  app.innerHTML = `
    <div class="page-enter">
      ...
      return showDue ? `
          ...
          <!-- Notes -->
          ${invoice.notes ? `
            <div class="inv-notes" style="margin: 12px 0; padding: 10px 14px; border-left: 3px solid var(--accent, #6366f1); background: rgba(99,102,241,0.07); border-radius: 6px; font-size: 0.82rem; color: var(--text-secondary);">
              <strong style="display:block; margin-bottom:4px; font-size:0.75rem; text-transform:uppercase; letter-spacing:0.8px; color:var(--text-muted);">Note</strong>
              ${invoice.notes}
            </div>
          ` : ''}
          ...
          <div class="inv-footer">
            ...
            <div style="display:flex; flex-direction:column; align-items:flex-end; gap:6px; border-top: 1px solid #bbb; padding-top: 8px;">
              ${business.signature
                ? `<img src="${business.signature}" alt="Signature" class="inv-signature-img">`
                : ''}
              <span class="inv-signature">AUTHORISED SIGNATURE</span>
            </div>
          </div>
